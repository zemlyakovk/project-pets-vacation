  ...
  return (
    ...
    <div class="rounded-lg shadow-lg bg-white w-[600px]">
      ...
      <div className='ml-2 '>
        ...
        <p className='mb-2 font-bold'>Имя</p>
      <div className='flex flex-row mt-2'>
        ...
        <p class="text-gray-700 text-base my-2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eos est sequi commodi veritatis ipsam quia excepturi quo. Laudantium voluptatem cupiditate temporibus perferendis nisi labore. Delectus id cumque inventore consequuntur mollitia.
        </p>
      </div>
