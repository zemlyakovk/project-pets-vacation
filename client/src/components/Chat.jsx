...
export default function Chat() {
  const { auth: { first_name } } = useSelector((state) => state);
    ...
    <div className="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen">
        ...
        <div className="relative flex items-center space-x-4">
          ...
          <div className="flex flex-col leading-tight">
            <div className="text-2xl mt-1 flex items-center">
              <span className="text-gray-700 mr-3">Ваня Крылов</span>
            </div>
            <span className="text-lg text-gray-600">Хозяин собаки</span>
          </div>
        </div>
      ...
      <div className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
        <div className="relative flex">
          ...
          <input type="text" placeholder="Сообщение" className="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3"/>
